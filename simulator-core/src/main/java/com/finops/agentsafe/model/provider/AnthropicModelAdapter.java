...
/**
 * Provider adapter skeleton for Anthropic Claude LLM integration.
 * Remains DISABLED unless ANTHROPIC_API_KEY environment variable is present.
 */
@Component
public class AnthropicModelAdapter implements ModelAdapter {

    public static final String PROVIDER_NAME = "anthropic";
    public static final String ENV_KEY = "ANTHROPIC_API_KEY";
    ...
    public AnthropicModelAdapter(String apiKey) {
        this.apiKey = apiKey;
    }
    ...
    public ModelMetadata getMetadata(ModelConfiguration config) {
        return new ModelMetadata(
            PROVIDER_NAME,
            config != null && config.getModelName() != null ? config.getModelName() : "claude-3-5-sonnet-20241022",
            "3.5-sonnet",
            "1.0.0",
    ...
    public ModelResponse predict(ModelRequest request) {
        ...
        return ModelResponse.failure(
            ModelError.providerError("Anthropic live API call skipped in test environment.", false),
            metadata,
            usage
        );
    }
